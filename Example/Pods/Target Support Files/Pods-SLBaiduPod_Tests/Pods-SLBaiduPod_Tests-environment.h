...
// SLBaiduPod
#define COCOAPODS_POD_AVAILABLE_SLBaiduPod
#define COCOAPODS_VERSION_MAJOR_SLBaiduPod 0
#define COCOAPODS_VERSION_MINOR_SLBaiduPod 1
#define COCOAPODS_VERSION_PATCH_SLBaiduPod 1
